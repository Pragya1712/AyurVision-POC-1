...
export default function AyurVisionLanding() {
  ...
  // --- FAQ LOGIC ---
  const faqs = [
    { question: "What images should I upload?", answer: "You can upload a clear photo of your face (neutral expression, good lighting) and your tongue. Both are traditional Ayurvedic indicators." },
    { question: "How does the image analysis work?", answer: "Our AI analyzes facial features (skin texture, characteristics) and tongue appearance (color, coating) based on Ayurvedic principles to identify Dosha patterns." },
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              Discover your unique Ayurvedic constitution through advanced image analysis combined with traditional wisdom. Simply upload a photo of your face or tongue, answer personalized questions, and receive an instant Prakriti analysis with tailored wellness recommendations.
            </p>
            <p className="text-lg text-slate-600 leading-relaxed pb-4">
              Our AI-powered platform analyzes facial features and tongue characteristics - key indicators in Ayurvedic analysis - to identify your dominant doshas (Vata, Pitta, Kapha) and provide personalized guidance for optimal health and balance.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 relative">
            ...
            <FeatureIcon icon={<Sparkles className="w-8 h-8 text-rose-500" />} bg="bg-rose-50" title="Get Analysis" desc="Receive your Prakriti analysis with personalized wellness recommendations." />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-left">
            <CardBox icon={<ScanFace className="w-8 h-8 text-green-600" />} title="AI-Powered Analysis" desc="Advanced image recognition technology combined with traditional Ayurvedic analysis methods." />
            ...
            <CardBox icon={<Zap className="w-8 h-8 text-amber-500" />} title="Instant Results" desc="Get your complete Prakriti analysis in minutes with actionable wellness recommendations." />
          </div>
        </div>
      </section>
